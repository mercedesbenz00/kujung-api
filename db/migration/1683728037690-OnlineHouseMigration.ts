...
export class OnlineHouseMigration1683728037690 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'online_houses',
      new TableIndex({
        name: 'idx_online_house_requested_at',
    ...
    await queryRunner.createIndex(
      'online_houses',
      new TableIndex({
        name: 'idx_online_house_rejected_at',
    ...
    await queryRunner.createIndex(
      'online_houses',
      new TableIndex({
        name: 'idx_online_house_approved_at',
    ...
    await queryRunner.createIndex(
      'online_houses',
      new TableIndex({
        name: 'idx_online_house_is_this_month',
    ...
    await queryRunner.createForeignKey(
      'online_houses',
      new TableForeignKey({
        name: 'FK_online_houses_product_id_products',
    ...
    await queryRunner.createForeignKey(
      'online_houses',
      new TableForeignKey({
        name: 'FK_online_houses_label_id_labels',
    ...
    await queryRunner.createForeignKey(
      'online_houses',
      new TableForeignKey({
        name: 'FK_online_houses_requested_by_users',
    ...
    await queryRunner.createForeignKey(
      'online_houses',
      new TableForeignKey({
        name: 'FK_online_houses_managed_by_admins',
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKey(
      'online_houses',
      'FK_online_houses_product_id_products',
    );
    await queryRunner.dropForeignKey(
      'online_houses',
      'FK_online_houses_label_id_labels',
    );
    await queryRunner.dropForeignKey(
      'online_houses',
      'FK_online_houses_requested_by_users',
    );
    await queryRunner.dropForeignKey(
      'online_houses',
      'FK_online_houses_managed_by_admins',
    );

    // Drop the indexes
    await queryRunner.dropIndex(
      'online_houses',
      'idx_online_house_is_this_month',
    );
    ...
    await queryRunner.dropIndex('online_houses', 'idx_online_house_status');
    await queryRunner.dropIndex(
      'online_houses',
      'idx_online_house_requested_at',
    );
    await queryRunner.dropIndex(
      'online_houses',
      'idx_online_house_rejected_at',
    );
    await queryRunner.dropIndex(
      'online_houses',
      'idx_online_house_approved_at',
    );

    // Drop the "online_houses" table
    await queryRunner.dropTable('online_houses');
  }
}
